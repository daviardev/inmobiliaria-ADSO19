import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css              */import{r as b,l as y,a as i}from"./api-DRR1AW4h.js";function m(t){return Number(t||0).toLocaleString("es-CO",{style:"currency",currency:"COP",maximumFractionDigits:0})}function v(t){return t?new Date(t).toLocaleDateString("es-CO"):"—"}function l(t,r){const e=document.getElementById(t);e&&(e.textContent=r)}function u(t="Cargando..."){let r=document.getElementById("loader-overlay");r||(r=document.createElement("div"),r.id="loader-overlay",r.className="loader-overlay",r.innerHTML=`
